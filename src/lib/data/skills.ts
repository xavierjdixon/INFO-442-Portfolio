...
export const items = [
	...
	defineSkill({
		...
		color: 'purple',
		description:
			'Figma is a collaborative interface design tool used for UI/UX prototyping, wireframing, and visual design. It enables teams to design and iterate in real-time with ease.',
		logo: Assets.Figma,
		name: 'Figma',
		category: 'design'
	}),
